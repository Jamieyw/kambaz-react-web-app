...
export default function TOC() {  // TOC: Table of Contents
  ...
  return (
    <Nav variant="pills" id="wd-toc">
      ...
      <Nav.Item>
        <Nav.Link as={Link} to="/Labs/Lab5" id="wd-a4"
          active={pathname.includes("Lab5")}>Lab 5</Nav.Link>
      </Nav.Item>
      <Nav.Item>
        <Nav.Link as={Link} to="/Kambaz" id="wd-kambaz">Kambaz</Nav.Link>
      </Nav.Item>
      <Nav.Item>
        <Nav.Link href="https://github.com/Jamieyw" target="_blank">My GitHub</Nav.Link>
      </Nav.Item>
    </Nav>
  );
}